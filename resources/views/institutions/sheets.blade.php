                        ...
                        <tr>   
                            ...
                            <td width="10px">
                                ...
                                @if($institution->hasSheet($sheet->id))    
                                    <a class="btn btn-danger text-white" href="{{ route('institutionSheet.detach',[$institution,$sheet]) }}">Quitar</a>
                                @else
                                    <a class="btn btn-info text-white" 
                                    href="{{ route('institutionSheet.attach',[$institution,$sheet]) }}">Agregar</a>
