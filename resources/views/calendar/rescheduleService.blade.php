...
<div class="card mx-4">
    <div class="card-header">
        Agenda: <strong>
          {{ucFirst($service->name)}}</strong><br>
        Reagendar turno de: 
        <strong>       {{ucfirst($patient->nombrePaciente).' '.ucfirst($patient->apellidoPaciente)}} </strong>
    </div>
    <div class="card-body">
        <form id="rescheduleForm" action="{{ route('appointmentService.restore') }}" method="POST">
            @method('POST')
            @csrf
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="service" value="{{ucfirst($service->name)}}" readonly>
